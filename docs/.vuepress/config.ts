...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "猿小熊",
      description: '认准一个方向 ，一直走下去，沉淀，积累，时间会给你惊喜。JavaScript,js,ES6,TypeScript,vue,React,python,css3,html5,Node,git,github等技术文章。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'yuanxiaoxiong/vuepress-theme-vdoing', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'yuanxiaoxiong', // 必需
      link: 'https://github.com/yuanxiaoxiong', // 可选的
    },
